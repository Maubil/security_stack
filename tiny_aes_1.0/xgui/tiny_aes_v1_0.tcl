...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "AES_KEY_LENGTH" -widget comboBox

}

proc update_PARAM_VALUE.AES_KEY_LENGTH { PARAM_VALUE.AES_KEY_LENGTH } {
	# Procedure called to update AES_KEY_LENGTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.AES_KEY_LENGTH { PARAM_VALUE.AES_KEY_LENGTH } {
	# Procedure called to validate AES_KEY_LENGTH
	return true
}
...
proc update_MODELPARAM_VALUE.AES_KEY_LENGTH { MODELPARAM_VALUE.AES_KEY_LENGTH PARAM_VALUE.AES_KEY_LENGTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.AES_KEY_LENGTH}] ${MODELPARAM_VALUE.AES_KEY_LENGTH}
}
